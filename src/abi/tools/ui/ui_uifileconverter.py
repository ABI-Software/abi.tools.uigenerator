...
class Ui_UiFileConverter(object):
    ...
    def retranslateUi(self, UiFileConverter):
        ...
        self.actionSettings.setText(QtGui.QApplication.translate("UiFileConverter", "Settings", None, QtGui.QApplication.UnicodeUTF8))
        self.action_About.setText(QtGui.QApplication.translate("UiFileConverter", "&About", None, QtGui.QApplication.UnicodeUTF8))
        self.actionEmpty.setText(QtGui.QApplication.translate("UiFileConverter", "Empty", None, QtGui.QApplication.UnicodeUTF8))
